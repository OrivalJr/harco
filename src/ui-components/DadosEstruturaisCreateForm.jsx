...
export default function DadosEstruturaisCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    setDataconstrucao(initialValues.dataconstrucao);
    setIdadepredial(initialValues.idadepredial);
    setQtdunidades(initialValues.qtdunidades);
    setQtdaptsresidenciais(initialValues.qtdaptsresidenciais);
    setQtdsalascomerciais(initialValues.qtdsalascomerciais);
    setErrors({});
  };
  const validations = {
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new DadosEstruturais(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "DadosEstruturaisCreateForm")}
      {...rest}
    >
      <TextField
