...
export default function ConvencoesRegulamentosCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    setPossuiconvencao(initialValues.possuiconvencao);
    setPossuiregistro(initialValues.possuiregistro);
    setDataregistro(initialValues.dataregistro);
    setCartorio(initialValues.cartorio);
    setPossuiregulamentointerno(initialValues.possuiregulamentointerno);
    setErrors({});
  };
  const validations = {
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new ConvencoesRegulamentos(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "ConvencoesRegulamentosCreateForm")}
      {...rest}
    >
      <TextField
